...
class HomologyDebugger(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Homology Engine Debugger")
    ...
    def setup_sidebar(self):
        ...
        self.tasks = {
            1: ("Extended GCD", "level_1_gcdex", "Level1GCD"),
            2: ("Matrix Operations", "level_2_matrix", "Level2Matrix"),
            3: ("Smith Normal Form", "level_3_snf", "Level3SNF"),
            4: ("Boundary Matrices", "level_4_boundary", "Level4Boundary"),
            5: ("Homology Computation", "level_5_homology", "Level5Homology")
        }
    ...
    def run_main_simulation(self):
        try:
            subprocess.Popen([sys.executable, "homology_explorer.py"])
        except Exception as e:
            messagebox.showerror("Execution Error", f"Failed to launch homology_explorer.py:\n{e}")

if __name__ == "__main__":
    app = HomologyDebugger()
    app.mainloop()
