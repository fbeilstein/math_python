...
[[0, 1]]
![](./assets/basis_b2.png){height=250px center}
...
![](./assets/continuity_pointwise.png){height=250px center} &nbsp;

[[0, 1]]
**(B) Global (preimages):** For every open set $V \in \tau_Y$, the preimage $f^{-1}(V) \in \tau_X$.

![](./assets/continuity_global.png){height=250px center} &nbsp;
:::
...
[[0, 1]]
![](./assets/hausdorff_separation.png){center} &nbsp;
...
![](./assets/topologist_sine_curve.png){center} &nbsp;
:::
...
![](./assets/metric_balls.png){center}
...
| Manifold | Dim | Compact? | Orientable? |
|----------|-----|----------|-------------|
| $S^n$ | $n$ | Yes | Yes |
| $T^2$ | 2 | Yes | Yes |
| $\mathbb{RP}^2$ | 2 | Yes | No |
...
[[0, 1]]
![](./assets/manifold_transition.png){center} &nbsp;
:::
