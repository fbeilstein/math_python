...
\lstinline|implementation_tasks.py| & \textcolor{red}{Here you write your code.} Contains the core algebraic topology logic (boundary matrices, Smith Normal Form, Homology) intended for student implementation. \\
