...
from levels.level_1_2d import Level12D
from levels.level_2_quaternion import Level2Quaternion
from levels.level_3_dual_quaternion import Level3DualQuaternion
from main_demo import MainDemo

class LabDashboard(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Kinematics Laboratory: Hypercomplex Numbers")
        self.geometry("1100x700")
        self.configure(bg="#1e1e1e")
        
        tk.Label(self, text="Kinematics Laboratory: Transformations", font=("Arial", 16, "bold"), bg="#1e1e1e", fg="#007acc").pack(pady=5)
        
        self.global_left = tk.Frame(self, bg="#1e1e1e", width=250)
        ...
        levels = [
            (Level12D, "L1: 2D Hypercomplex"),
            (Level2Quaternion, "L2: 3D Quaternions"),
            (Level3DualQuaternion, "L3: 3D Dual Quaternions"),
            (MainDemo, "L4: ScLERP Kinematics Demo")
        ]
