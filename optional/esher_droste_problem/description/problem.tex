...
Run the file \lstinline|droste_lab_dashboard.py|. You should see the window with a checkerboard and blue rectangle. You can also add your own \lstinline|unittest.TestCase| classes at the bottom of \lstinline|implementation_tasks.py| and run \lstinline|python implementation_tasks.py| to execute them.
