...
- **Warm-up:** [Group Theory](https://github.com/fbeilstein/math_python/releases/download/groups_v1/group_problem.zip)
- **Practice:** [Generate QR-code](https://github.com/fbeilstein/math_python/releases/download/qr_v3/qr_problem.zip)
