...
\lstinline|levels/level_*.py| & Unittests and graphical representation for each specific problem. \textbf{Run standalone} for visual debugging. Append \lstinline|--no-graphics| to only run the unit tests. \\
