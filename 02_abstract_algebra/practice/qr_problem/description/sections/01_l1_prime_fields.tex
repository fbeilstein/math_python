...
\begin{itemize}
    ...
    \item Use binary exponentiation (exponentiation by squaring) for \lstinline|__pow__| to guarantee $O(\log n)$ complexity. Ensure $0^0 = 1$.
    \item Implement \lstinline|__bool__| to return \lstinline|True| if the element is non-zero. This enables polymorphic truth-value testing (\lstinline|if element:|) across our entire backend without explicitly checking \lstinline|element != field.zero|.
\end{itemize}
...
\_\_add\_\_ & \lstinline|self, other| & \lstinline|GaloisFieldElement| \\
\_\_sub\_\_ & \lstinline|self, other| & \lstinline|GaloisFieldElement| \\
\_\_mul\_\_ & \lstinline|self, other| & \lstinline|GaloisFieldElement| \\
\_\_truediv\_\_ & \lstinline|self, other| & \lstinline|GaloisFieldElement| \\
...
\textbf{UI Guide:} Open \lstinline|qr_lab_dashboard.py| and navigate to the early debugging tabs if you wish to see how field elements wrap around algebraically.
