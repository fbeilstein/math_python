...
\begin{itemize}
    ...
    \item Multiply $g(x)$ by the linear factor $(x - \alpha^i)$. In our Low-to-High coefficient ordering, this translates to \lstinline|Polynomial([-(field.alpha ** i), field.one])|.
\end{itemize}
