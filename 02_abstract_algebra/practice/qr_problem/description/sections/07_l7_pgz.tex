...
pgz\_error\_locator & \lstinline|syndromes: list[GaloisFieldElement], field: ExtensionField| & \lstinline|Polynomial| \\
solve\_linear & \lstinline|A: list[list[GaloisFieldElement]], b: list[GaloisFieldElement]| & \lstinline|list[GaloisFieldElement]| \\
\bottomrule
\end{tabularx}
\end{center}
