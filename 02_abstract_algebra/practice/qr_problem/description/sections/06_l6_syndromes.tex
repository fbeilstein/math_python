...
\begin{itemize}
    ...
    \item Call your generic polynomial evaluation method (\lstinline|__call__| with Horner's rule) on \lstinline|message_poly|, passing in \lstinline|field.alpha ** i|.
