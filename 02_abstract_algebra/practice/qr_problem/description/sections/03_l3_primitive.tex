...
\begin{itemize}
    ...
    \item Construct $x$ as \lstinline|Polynomial([field.one, field.zero])| and $1$ as \lstinline|Polynomial([field.one])|.
    \item Use Python's built-in \lstinline|pow(base, exponent, modulus)|. Your \lstinline|Polynomial.__pow__| method from Level 2 should natively support the optional third \lstinline|modulus| argument, enabling rapid modular binary exponentiation!
\end{itemize}
...
\textbf{UI Guide:} In \lstinline|qr_lab_dashboard.py|, you can inspect how different choices of polynomial affect the generated multiplication tables, and how a primitive polynomial perfectly cycles through all non-zero elements.
