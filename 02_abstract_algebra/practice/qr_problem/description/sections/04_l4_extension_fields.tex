...
\textbf{Task:} Complete the \lstinline|_initialize| setup method, the \lstinline|@property| fields, and the \lstinline|exp| method.
...
zero, one & \lstinline|self| (\texttt{@property}) & \lstinline|GaloisFieldElement| \\
