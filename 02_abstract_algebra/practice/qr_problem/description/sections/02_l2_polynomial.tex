...
\begin{itemize}
    \item \lstinline|__init__|: Store the low-to-high coefficients. (You do not need \lstinline|_trim| if you use a dict).
...
\_\_call\_\_ & \lstinline|self, x| & \lstinline|FieldElement| \\
\bottomrule
\end{tabularx}
\end{center}
