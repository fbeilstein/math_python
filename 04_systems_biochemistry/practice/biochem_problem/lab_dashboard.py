...
class BiochemDebugger(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Systems Biochemistry Dashboard")
    ...
    def setup_sidebar(self):
        ...
        self.tasks = {
            1: ("pH Titration", "level_1_titration", "Level1Titration"),
            2: ("Enzyme Inhibition", "level_2_inhibition", "Level2Inhibition"),
            3: ("Myxococcus Signal", "level_3_myxococcus", "Level3Myxococcus"),
            4: ("Glycolysis Bifurcation", "level_4_glycolysis", "Level4Glycolysis"),
            5: ("Bio-switch", "level_5_bioswitch", "Level5Bioswitch"),
            6: ("Cusp Catastrophe", "level_6_cusp", "Level6Cusp")
        }
    ...
    def switch_sandbox(self, level_num):
        ...
        try:
            ...
            self.current_handler = level_class(self)
            self.canvas.draw()
